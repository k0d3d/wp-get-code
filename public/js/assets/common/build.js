...
define("getCodeApp", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getCodeApp = void 0;
    ...
    exports.getCodeApp = window['GetCodeAppVars'];
});
define("common/fetch", ["require", "exports", "getCodeApp"], function (require, exports, getCodeApp_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.invokeIntent = exports.handlePurchase = void 0;
    var handlePurchase = function (intent) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    exports.invokeIntent = invokeIntent;
});
/* eslint-disable @typescript-eslint/ban-ts-comment */
define("common/utils", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.isSuccessCode = exports.scrollToElement = exports.adjustHeight = void 0;
...
define("common/woo-service", ["require", "exports", "common/utils"], function (require, exports, utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var $ = window.jQuery;
    var WooCommerce = /** @class */ (function () {
        ...
        WooCommerce.prototype.validateWCCheckoutForm = function () {
            ...
            if (!invalidInput)
                ...
                (0, utils_1.scrollToElement)(invalidInput);
                return false;
        ...
        WooCommerce.prototype.handleCheckoutAJAXComplete = function (statusCode, isFailed) {
            if (isFailed || !(0, utils_1.isSuccessCode)(statusCode)) {
...
define("app", ["require", "exports", "common/fetch", "common/woo-service"], function (require, exports, fetch_1, woo_service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var woo = new woo_service_1.default();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                button.on('cancel', function (e) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (0, fetch_1.handlePurchase)(e.intent)];
                            case 1:
                                _a.sent();
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, (0, fetch_1.invokeIntent)({
                                        currency: 'usd',
                                        destination: window['GetCodeAppVars'].destination,
